...
set +e
ssh pivotal@bacon.flood.pivotallabs.com 'ssh -i /Users/pivotal/.ssh/id_union_deploy deploy@union /bin/ls -cr  /Volumes/PivotLand/DeployStudio/Masters/HFS/lion_{1[1-9]-*,HEAD}.i386.hfs.dmg | tail -n +2 | xargs echo rm'
set -e
